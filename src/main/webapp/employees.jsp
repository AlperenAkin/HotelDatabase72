...
<body>
    <div class="header">
        ...
        <form method="post" action="employee_create.jsp"> <!-- Update with your booking servlet -->
                                    ...
                                    <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="employee_update.jsp"> <!-- Update with your booking servlet -->
                                                    ...
                                                    <td>
                                                        <form method="POST" action="employee_delete_controller.jsp">

                                                            <input type="hidden" value="<%= employee.getEmployeeId() %>" name="employee_id" />
