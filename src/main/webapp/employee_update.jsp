            ...
            <div class="col-md-12">
                <form class="form-horizontal" name="hotel-creation-form" action="employee_update_controller.jsp" method="POST">
                    <div class="form-group col-sm-3 mb-3">
                        ...
                        <input type="text" readonly class="form-control" name="employee_id" placeholder="employeeid" value="<%=employee_id%>">
                    </div>
                    <div class="form-group col-sm-3 mb-3">
                        <label for="first_name">First Name</label>
                        <input type="text" class="form-control" name="first_name" placeholder="firstname" value="<%=first_name%>">
                    </div>
                    <div class="form-group col-sm-3 mb-3">
                        <label for="last_name">Last Name</label>
                        <input type="text" class="form-control" name="last_name" placeholder="lastname" value="<%=last_name%>">
                    </div>
                    <div class="form-group  col-sm-3 mb-3">
